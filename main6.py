...
# --- Game States ---
START, PLAYING, GAME_OVER, DRAW = "start", "playing", "game_over", "draw"
...
# --- Main Game Function ---
def main():
    global game_state, current_round, snake1_wins, snake2_wins
    ...
    while True:
        ...
        if game_state == START:
            ...
            # Check for snake-to-snake collisions (ADDED COLLISION CHECK)
            if snake1.alive and snake2.alive:
                # Check if either snake's head collides with the other's body
            ...
            if not snake1.alive or not snake2.alive:
                if not snake1.alive and snake1.score <= snake2.score:
                    winner = "Agent 2"
                    snake2_wins += 1
                elif not snake2.alive and snake2.score <= snake1.score:
                    winner = "Agent 1"
                    snake1_wins += 1
                else:
                    winner = None
            ...
            draw_game_over_screen(final_winner)
        ...
        if game_state == PLAYING:
            ...
            score1 = font.render(f"Agent 1: {snake1.score}", True, GREEN)
            score2 = font.render(f"Agent 2: {snake2.score}", True, YELLOW)
            screen.blit(score1, (10, 10))
            screen.blit(score2, (WIDTH - score2.get_width() - 10, 10))
