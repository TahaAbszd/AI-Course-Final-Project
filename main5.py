...
large_font = pygame.font.SysFont('Poppins', 60, bold=True)
medium_font = pygame.font.SysFont('Poppins', 36)
...
def draw_game_over_screen(snake1, snake2):
    screen.fill(BLACK)
    title = large_font.render("Game Over", True, RED)
    screen.blit(title, (WIDTH // 2 - title.get_width() // 2, HEIGHT // 4))

    if snake1.score > snake2.score:
        result = f"{snake1.agent_id} Wins!"
    elif snake2.score > snake1.score:
        result = f"{snake2.agent_id} Wins!"
    else:
        result = "It's a Tie!"

    result_text = medium_font.render(result, True, WHITE)
...
def draw_game(snake1, snake2, food):
    screen.fill(BLACK)
    ...
    score1 = font.render(f"{snake1.agent_id}: {snake1.score}", True, GREEN)
    score2 = font.render(f"{snake2.agent_id}: {snake2.score}", True, YELLOW)
...
def main():
    ...
    while True:
        ...
        if game_state == START:
            ...
            draw_game_over_screen(snake1, snake2)
